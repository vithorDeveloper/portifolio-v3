import {GithubLogo, CaretCircleRight } from "@phosphor-icons/react";
...
export function Project({icons, title, description, url}){
  ...
  return(
      <article ref={animateRef1}  className={`lg:m-auto lg:h-full text-center mb-16 text-white transition duration-1000 transform ${ isVisible1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"}`}>
